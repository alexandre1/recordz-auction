...
@Route(value = "encheres", layout = MainLayout.class)
@PageTitle("Recordz — Enchères")
@PermitAll
public class EncheresView extends VerticalLayout implements HasUrlParameter<Integer>  {
    ...
    public void setParameter(BeforeEvent event, @OptionalParameter Integer page) {
        ...
        List<Article> articles = articleService.findActiveArticlesByVendeur(
